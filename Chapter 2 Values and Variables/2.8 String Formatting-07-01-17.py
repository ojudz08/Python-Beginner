...
print('\nListing 2.19: Powers 10 left 2')
print('Uses the bracket and .format in formatting.')
print('The first bracket corresponds to the first item and the 2nd bracket corresponds to the power in .format ')
