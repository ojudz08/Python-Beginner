'''print("\nListing 7.17: Square Root Function")
#  Computethe approximate square root of val
#  val is a number
def square_root(val):
...
print("\nListing 7.18: Square Root Comparison")
...
#     floating-pint values such as floating-point infinity
#     requires an exact equality check.
